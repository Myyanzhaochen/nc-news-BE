...
const createRef = require("../seeds/utils")
  ...
  return db.query(`DROP TABLE IF EXISTS comments`)
    ...
    .then(({ rows }) => {
      ...
      const formattedComments = commentData.map((comment) => { 
        return [ articleIdLookup[comment.article_title], comment.body, comment.votes, comment.author, comment.created_at]
      })

      const queryStr = format(`INSERT INTO comments(article_id, body, votes, author, created_at) VALUES %L`, formattedComments)
